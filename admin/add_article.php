...
if (isset($_POST['add_article'])) {
  ...
  if (empty($title)) {
    ...
    $checkSlugSql = "SELECT id FROM articles WHERE slug = ?";
    ...
    if (empty($errorMsg)) {
      ...
      // Insert article
      $insertSql = "INSERT INTO articles (title, slug, author, author_role, content, excerpt, image, category_id, tags, featured, created_at, view_count) 
                   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0)";
      ...
      if ($insertStmt->execute()) {
        $successMsg = "Article added successfully";
        // Reset form
        $title = "";
        $author = "";
        $author_role = "";
        ...
        $errorMsg = "Error adding article: " . $conn->error;
      }
    }
  }
}
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="d-grid gap-2">
                <button type="submit" name="add_article" class="btn btn-primary btn-lg">Publish Article</button>
